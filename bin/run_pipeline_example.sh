...
fastq_format=".fastq"
fastq_dir="/home/mishras10/MAPS/examples/test_set1"
outdir="/home/mishras10/MAPS/examples/outputs/test_set1"
macs2_filepath="/home/mishras10/MAPS/examples/test_set1/macs2_peaks_final.replicated.narrowPeak"
organism="mm10"
index=""
index_fa=""
bin_size=10000
...
####################################################################
dataset1="/home/mishras10/MAPS/PLAC-Seq_datasets/test_dataset2/feather_output/test_set1_current"
dataset2="/home/mishras10/MAPS/PLAC-Seq_datasets/test_dataset2/feather_output/test_set2_current"
dataset3=""
dataset4=""
#...
##################################################################
...
if [ $organism == "mm10" ]; then
	if [ -z $index ]; then
        	index="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/mm10.index"
      		index_fa="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/mm10.fa"
	fi
	...
	if [ -z $index ]; then
		index_fa="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/mm9.fa"
    index="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/mm9.index"
	fi
	...
	if [ -z $index ]; then
		index_fa="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/hg19.fa"
    index="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/hg19.index"
	fi
	...
	if [ -z $index ]; then
		index_fa="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/GRCh38_no_alt_analysis_set_GCA_000001405.15.fasta"
    index="/home/mishras10/MAPS/MAPS_data_files/"$organism"/BWA_index/GRCh38_no_alt_analysis_set_GCA_000001405.15.index"
	fi
...
#genomic_feat_filepath="/home/mishras10/MAPS/MAPS_data_files/"$organism"/genomic_features/"$genomic_features_filename
...
if [ $feather -eq 1 ]; then
	...
	if [ $number_of_datasets -ge 2 ]; then
		...
		$python_path $cwd/feather/feather_pipe preprocess -o $feather_output -p $dataset_name -f1 $fastq1 -f2 $fastq2 -b $index -fa $index_fa -q $mapq -l $length_cutoff -t $threads -c $per_chr -j $generate_hic -a $macs2_filepath -d $optical_duplicate_distance
